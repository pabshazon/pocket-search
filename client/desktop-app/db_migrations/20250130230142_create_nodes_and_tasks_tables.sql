...
CREATE TABLE hyper_node (
    ...
    cs_hnode_title TEXT,
    cs_hnode_title_embedding FLOAT[128],
    cs_hnode_summary TEXT,
    cs_hnode_summary_embedding FLOAT[128],
    cs_explain_contains TEXT,
    cs_explain_contains_embedding FLOAT[128],
    cs_what_info_can_be_found TEXT,
    cs_what_info_can_be_found_embedding FLOAT[128],
...
-- CREATE INDEX idx_hyper_node_title_embedding ON hyper_node(cs_hnode_title_embedding) USING vec0;
-- CREATE INDEX idx_hyper_node_summary_embedding ON hyper_node(cs_hnode_summary_embedding) USING vec0;
-- CREATE INDEX idx_hyper_node_explain_contains_embedding ON hyper_node(cs_explain_contains_embedding) USING vec0;
-- CREATE INDEX idx_hyper_node_what_info_can_be_found_embedding ON hyper_node(cs_what_info_can_be_found_embedding) USING vec0;
